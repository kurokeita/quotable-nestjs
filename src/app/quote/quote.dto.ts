...
import { IsArray, IsDefined, IsEnum, IsIn, IsInt, IsOptional, IsString, Min, ValidateIf } from 'class-validator'
...
export class IndexQuotesDto {
	...
	@Transform(({ value }) => {
		...
		return QuoteSortByEnum[_.toUpper(_.snakeCase(value)) as keyof typeof QuoteSortByEnum]
	})
...
export class GetRandomQuotesDto extends OmitType(IndexQuotesDto, ['page'] as const) {}
...
export class UpdateQuoteDto extends OmitType(CreateQuoteDto, ['authorId', 'author'] as const) {}
